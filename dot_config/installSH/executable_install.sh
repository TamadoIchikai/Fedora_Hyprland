...
echo -e "${CYAN}Mount the shared drive (shared with window 11), the mounted directory must be named sda2 for easiest combability with syncthing, resicprofile: ${NC}"
echo -e "${CYAN}-> sudo mkdir /mnt/sda2/${NC}"
echo -e ""
echo -e "${CYAN}-> sudo mount /dev/sda2 /mnt/sda2${NC}"
echo -e ""
echo -e "${CYAN}-> Open Obsidian and then open -Linux setup- then follow guild to pernament mount the drive${NC}"
...
echo -e ""
echo -e "${CYAN}~/.config/systemd/user/syncthing.service: ${NC}"
echo -e ""
echo -e "${CYAN}-> systemctl --user enable syncthing.service${NC}"
echo -e ""
echo -e "${CYAN}Resticprofiles - run the schedule to create systemd scheduler, firstly config rclone storage: ${NC}"
echo -e ""
echo -e "${CYAN}-> rclone config${NC}"
echo -e ""
echo -e "${CYAN}given that gdrive is my remote cloud: ${NC}"
echo -e ""
echo -e "${CYAN}-> rclone lsd gdrive ${NC}"
echo -e ""
echo -e "${CYAN}check current resticprofiles sucessfully connect with restic and rclone: ${NC}"
echo -e ""
echo -e "${CYAN}-> resticprofile -c /mnt/sda2/Resticprofiles/profiles.yaml -n default snapshots${NC}"
echo -e ""
